...
class ReservasDisponiblesUserScreen extends StatefulWidget {
  const ReservasDisponiblesUserScreen({super.key});

  @override
  State<ReservasDisponiblesUserScreen> createState() => _ReservasDisponiblesUserScreenState();
}

class _ReservasDisponiblesUserScreenState extends State<ReservasDisponiblesUserScreen> {
  late Future<List<ReservasModel>> _reservasDisponiblesFuture;

  @override
  void initState() {
    super.initState();
    AppLogger.info("Cargando pantalla de reservas", tag: "RESERVAS_USER");
    _reservasDisponiblesFuture = ReservasService().getAllReservasUser();
  }
    ...
    return Scaffold(
      ...
      body: Fondo(
        ...
        child: FutureBuilder<List<ReservasModel>>(
          future: _reservasDisponiblesFuture,
